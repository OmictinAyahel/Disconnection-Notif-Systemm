        ...
        <div class="row" id="dataTableSection" style="display: none;">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="modal send-sms-modal" id="sendSMSModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h5 class="modal-title" id="sendSMSModalLabel">Upload Excel File</h5>
                                    </div>
    ...
    <div class="modal fade" id="smsConfirmationModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="col-lg-6">
                    <button id="sendSingleSMSBtn" class="btn btn-primary float-right animate__animated animate__fadeInUp" style="display: none;">Send SMS</button>
                    <button id="sendMultipleSMSBtn" class="btn btn-primary float-right animate__animated animate__fadeInUp" style="display: none;">Send SMS to All</button>
                </div>
            </div>
        </div>
    </div>
